...
/**
 * FRE - arrow-right-from-bracket icon from fontawesome
 * https://fontawesome.com/icons/arrow-right-from-bracket?s=solid
 *
 * @param props
 * @constructor
 */
export const ArrowRightFromBracket = (props: SvgProps) => (
  <Svg
...
const ArrowRightFromBracketMemo = memo(ArrowRightFromBracket);

export default ArrowRightFromBracketMemo;
