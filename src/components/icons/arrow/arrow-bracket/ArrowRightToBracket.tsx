...
/**
 * FRE - arrow-right-to-bracket icon from fontawesome
 * https://fontawesome.com/icons/arrow-right-to-bracket?s=solid
 *
 * @param props
 * @constructor
 */
const ArrowRightToBracketIcon = (props: SvgProps) => (
  <Svg
...
const ArrowRightToBracketIconMemo = memo(ArrowRightToBracketIcon);
export default ArrowRightToBracketIconMemo;
